!(function (t, e, i, n) {
  ...
  $(document).ready(function(){
    $(".testimonial-carousel").owlCarousel({
      ...
      loop: true, // Whether to loop back to the start after reaching the end
      margin: 10, // Margin around items
      autoplay: true, // Auto play the carousel
      autoplayTimeout: 1500, // Time delay between transitions
      autoplayHoverPause: true, // Pause autoplay on mouse hover
      nav: true, // Show navigation buttons
      dots: false, // Show pagination dots
      responsive: {
        0: {
          items: 1 // On screens smaller than 600px, show 1 item at a time
        },
        600: {
          items: 2 // On screens larger than 600px, show 2 items at a time
        },
        1000: {
          items: 3 // On screens larger than 1000px, show 3 items at a time
        }
      }
    });
   });
